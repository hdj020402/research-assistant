...
## 摘要（中文）
稀有细胞尽管只占细胞群体的极小部分，却在健康与疾病中发挥关键作用。例如，一小部分癌细胞即可驱动肿瘤的起始与进展。然而，由于稀有细胞丰度低且需要高精度的识别方法，对其检测和分析仍面临挑战。基于阻抗的微流控流式细胞术（μIFC）提供了一种无标记且信息丰富的单细胞表征方法。在本研究中，我们提出了一种基于支持向量机（SVM）学习策略的多频μIFC平台，用于准确区分稀有癌细胞与白细胞（WBCs）。我们的平台在区分三种癌细胞系——MDA-MB-231（乳腺癌）、A549（肺癌）和HeLa（宫颈癌）——与人永生化T淋巴细胞（Jurkat）或外周血单个核细胞（PBMCs）方面，准确率超过99%。为进一步提高检测可靠性，我们引入了一种预测后校正策略，以降低误检率。此外，我们证明了该平台能够在白细胞群体中以1%–10%的浓度检测稀有癌细胞，其检测结果与常规流式细胞术高度一致。这项工作建立了一个robust、无标记、基于机器学习增强的 μIFC平台，用于稀有癌细胞分析，为稀有细胞表征的更广泛应用奠定了基础。

## 笔记
<!-- 在此处添加阅读笔记 -->

## Links
- [Full Article](http://url5675.acs.org/ls/click?upn=u001.GXhmshJPA1t8vlxMR-2FToII2roP7p3-2BAW2NtcJEvBqZ6m9dwOKKpz9-2BWBhH0scpkFVYf-2Bg07apKqe9s5w2AXNKwdc-2F3gN2wWq-2Fku82aJX1paCdWC-2FNwRJXhG-2FJ3Srw2XQT5LhSXRcImFesZulfOMensnpfMHimUf8rqv2EPQgURAF5NnkFsp5dVt-2BZUZQIwnJUv0l_lCfgyiCVNF2aFl1C5Hre7Otyl3MOx4XtLxhxzfQ-2BJEA4TixnLSSnHKtti6TVNqJjICV4qvQArAsWThJep5QI9va7wIKdZVjaEZp8TavinUVQ6KkkGY2xim0AXIjJBGiAE88lm-2Bo-2FHhpHi4zQxQg1pKvpxcVAZVLZCiIWwS7DbYGuxYzaj-2B3dcYa-2B9Mlt4tkqY6mP8pg-2BcFpAdMB6PGsW0vDlRH-2FIm84dZwFeIwFOOgLIztrLoKeAgPhLrBSqoliU3oCJ9fl1c-2FMnm5UjIJNTgr54xnykBVOxqIucPbuTHVI-3D)
