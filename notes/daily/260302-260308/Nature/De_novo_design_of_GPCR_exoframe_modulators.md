...
## 摘要（中文）
G蛋白偶联受体 (gpcr) 是重要的治疗靶标，并且主要通过其正构位点被靶向，其中内源性激动剂结合。然而，变构调节已成为GPCR药物发现领域中一种有前途的创新策略。在这里，从跨膜蛋白对GPCR的自然调节中汲取灵感，我们开发了GPCR外框架调节剂 (GEMs)，这是从头设计的特异性靶向GPCR跨膜结构域的蛋白质。利用类似幻觉的设计方法，我们制作了具有三个战略性结构提示的宝石，以实现所需的绑定模式。我们选择多巴胺D 1受体作为原型模型，并系统地研究了四个宝石。结构研究和功能分析表明，这些gem与跨膜结构域结合，并充当多种变构调节剂，包括激动剂-正变构调节剂，负变构调节剂和偏置变构调节剂。Ago-pam GEM可恢复各种D 1受体功能丧失突变体的活性，这表明它是GPCR相关疾病的有希望的治疗靶标。我们的工作介绍了靶向跨膜结构域的gem作为变构GPCR调节的有效试剂，并强调了基于深度学习的方法在功能导向膜蛋白设计中的潜力。
