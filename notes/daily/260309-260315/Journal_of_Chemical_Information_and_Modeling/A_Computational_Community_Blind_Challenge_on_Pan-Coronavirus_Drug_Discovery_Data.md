...
title_zh: "泛冠状病毒药物发现数据的计算机社区盲测挑战"
...
pub_date: ""
tags: ["drug-discovery", "machine-learning", "computational-chemistry", "benchmark-challenge", "admet-prediction"]
ai_relevance: 4
relevance: null
innovation: null
methods: null
...
**泛冠状病毒药物发现数据的计算机社区盲测挑战**

## 精华总结
报告了泛冠状病毒抗病毒发现计划的药物发现计算盲测挑战的成果和关键见解,通过社区驱动的基准测试推进可重现和可信的计算方法,并探讨未来盲测挑战设计的最佳实践。

**关键词**: 药物发现、机器学习、盲测挑战、冠状病毒、ADMET预测
...
## 摘要（中文）
报告了一项开放科学社区盲测挑战的成果和关键见解,重点关注药物发现中的计算方法。该挑战使用AI驱动的结构赋能抗病毒平台发现联盟的先导优化数据,与Polaris和OpenADMET项目合作。全球参与者应用计算方法预测针对SARS-CoV-2和MERS-CoV主蛋白酶的小分子生化效力、晶体学配体姿态和多个ADMET测试终点。通过评估多个任务和化合物的提交,建立了性能排行榜并进行元分析,评估了方法优势、常见陷阱和改进领域,为实际机器学习评估的最佳实践奠定基础。
