...
title_zh: "使用可解释的神经ode实现可概括的数据驱动的药代动力学"
...
pub_date: ""
tags: ["neural-ode", "pharmacokinetics", "molecular-representations", "deep-learning", "precision-medicine"]
ai_relevance: 5
relevance: null
innovation: null
methods: null
...
**使用可解释的神经ode实现可概括的数据驱动的药代动力学**

## 精华总结
提出了Uni-PK框架，将分子表示与神经常微分方程嵌入到机制性药代动力学结构中，为下一代药代动力学建模和精准医疗提供了可扩展、可解释且减少动物实验的解决方案。

**关键词**: 神经常微分方程、药代动力学、分子表示、精准医疗、深度学习
