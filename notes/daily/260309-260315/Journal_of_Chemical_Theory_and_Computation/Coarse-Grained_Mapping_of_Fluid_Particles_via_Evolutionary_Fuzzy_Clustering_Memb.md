...
title_zh: "通过进化模糊聚类的流体粒子粗粒化映射：膜成员演化项作为压力修正机制"
...
pub_date: ""
tags: ["coarse-graining", "fuzzy-clustering", "molecular-dynamics", "machine-learning", "force-matching"]
ai_relevance: 3
relevance: null
innovation: null
methods: null
...
**通过进化模糊聚类的流体粒子粗粒化映射：膜成员演化项作为压力修正机制**

## 精华总结
提出熵正则化模糊聚类方法进行流体粗粒化，发现膜成员演化项可作为有效的压力修正机制，为多尺度模拟设计提供物理基础。

**关键词**: 粗粒化、模糊聚类、压力修正、分子动力学、多尺度模拟
...
## 摘要（中文）
提出了一种具有时间光滑约束的熵正则化模糊聚类方法用于流体粒子粗粒化。在力匹配框架内，簇间相互作用分解为粒子相互作用项和膜成员演化项两部分。研究表明中等模糊程度产生最显著的结构特征，膜成员演化项能有效恢复系统压力，为粗粒化动力学设计提供了新的压力修正方案。
