---
title: "Why Variational Density Functional Theory Is More Accurate Than Time-Dependent Density Functional Theory for Certain “Difficult” Excited States?"
title_zh: "为什么对于某些 “困难” 的激发态，变分密度泛函理论比时间相关的密度泛函理论更准确？"
journal: "Journal of Chemical Theory and Computation"
doi: "10.1021/acs.jctc.5c01108"
url: "https://app.acspubs.org/e/er?s=1913652004&lid=109589&pci=CACSR000013623915&elqTrackId=35716fb6113d4b4d8419ccfe95f19d16&elq=51f4713da496490ea94be1416e307abc&elqaid=32172&elqat=1&elqak=8AF5AC6B9AA0D692E26219AE429F58E72DA3DF669D1886211F10624EBC003E655BFD"
pub_date: ""
tags: ["density-functional-theory", "excited-states", "computational-chemistry", "charge-transfer"]
ai_relevance: 2
relevance: null
innovation: null
methods: null
...
**为什么对于某些 “困难” 的激发态，变分密度泛函理论比时间相关的密度泛函理论更准确？**

## 精华总结
本研究通过对比变分激发态密度泛函理论(eDFT)和TDDFT的能量方程,解释了为什么eDFT对电荷转移激发态、反演单重态-三重态间隙分子和芯激发等"困难"激发态的描述更准确。研究发现轨道弛豫与更大的Hartree和交换相关核贡献的共同作用是eDFT优越性能的关键。

**关键词**: 密度泛函理论、激发态、电荷转移激发态、轨道弛豫、Tamm-Dancoff近似
...
## 摘要（中文）
尽管时间相关的密度泛函理论 (TDDFT) 在各种激发态上都取得了巨大的成功，但对于特定类型的系统，例如电荷转移激发态，反向单重态-三重态间隙 (STG) 分子，核心激发，里德堡态等。变分激发态密度泛函理论 (eDFT) 已被证明可提供与 “行为良好” 系统的TDDFT相似的精度。然而，对于困难的激发态，eDFT始终表现更好，其中TDDFT产生显著的误差或不正确的定性结果。在本文中，比较了eDFT和两态tamm-dancoff近似 (TDA) TDDFT的能量方程，以研究这两种方法对三种类型激发的成功和失败的起源: 核心激发，反向STG分子和分子间电荷转移激发。开发了一种通用的分解方法，用于使用eDFT和TDDFT计算单重态和三重态激发能。使用这种分解方法，分析了不同功能对激发能各个分量的影响。还评估了eDFT激发能量对基础密度的敏感性。我们的分析表明，与TDDFT相比，eDFT激发能包括来自Hartree和交换相关内核的更高贡献。但是，eDFT中更大的内核贡献本身并不能保证提高准确性。包含轨道弛豫以及更大的内核贡献是eDFT在困难激发态方面优于常规TDDFT的原因。

## 笔记
<!-- 在此处添加阅读笔记 -->

## Links
- [Full Article](https://app.acspubs.org/e/er?s=1913652004&lid=109589&pci=CACSR000013623915&elqTrackId=35716fb6113d4b4d8419ccfe95f19d16&elq=51f4713da496490ea94be1416e307abc&elqaid=32172&elqat=1&elqak=8AF5AC6B9AA0D692E26219AE429F58E72DA3DF669D1886211F10624EBC003E655BFD)
