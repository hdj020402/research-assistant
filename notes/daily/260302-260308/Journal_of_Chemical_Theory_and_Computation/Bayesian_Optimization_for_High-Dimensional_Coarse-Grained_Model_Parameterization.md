...
pub_date: ""
tags: ["bayesian-optimization", "coarse-grained-modeling", "molecular-simulation", "hyperparameter-optimization", "polymer-materials"]
ai_relevance: 4
relevance: null
innovation: null
methods: null
...
## 精华总结
本研究成功将贝叶斯优化（BO）与树结构Parzen估计器（TPE）模型应用于高维粗粒化力场参数化，以Pebax聚合物为例，同时优化41个参数以再现关键物理性质。相比传统搜索算法，该方法收敛更快，且在密度、回旋半径和玻璃转化温度等结构热力学性质的再现上表现更优。
