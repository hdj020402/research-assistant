...
title_zh: "DFT超胞计算中的用户自定义静电势：实现及其在带电界面中的应用"
...
pub_date: ""
tags: ["dft-calculations", "electrochemistry", "computational-interface", "electric-fields", "software-implementation"]
ai_relevance: 2
relevance: null
innovation: null
methods: null
...
**DFT超胞计算中的用户自定义静电势：实现及其在带电界面中的应用**

## 精华总结
通过最近发布的VASP-Python接口实现了该方法，能够直接在标准VASP软件中应用用户定义的电场，提供了极大的灵活性和控制能力。

**关键词**: 密度泛函理论、电场、电化学界面、VASP-Python接口
