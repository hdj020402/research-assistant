...
pub_date: ""
tags: ["deep-learning", "mass-spectrometry", "metabolomics", "forensic-analysis", "preprocessing-automation"]
ai_relevance: 4
relevance: null
innovation: null
methods: null
...
## 精华总结
LCMS-Net通过直接处理原始LC-HRMS数据并显式建模其空间特性，消除了手动数据预处理的需要，使分析更快速、计算效率更高。
