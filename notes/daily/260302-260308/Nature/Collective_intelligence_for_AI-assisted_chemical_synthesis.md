...
pub_date: ""
tags: ["large-language-models", "chemical-synthesis", "reaction-prediction", "ai-assisted-discovery", "expert-systems"]
ai_relevance: 5
relevance: null
innovation: null
methods: null
...
## 精华总结
介绍了MOSAIC（多个优化的AI辅助化学预测专家）计算框架，该框架使化学家能够利用数百万个反应协议的集体知识来实现新化合物的合成。该方法在71%的成功率下验证了35种以上新化合物的合成，包括药物、材料、农用化学品和化妆品。

**关键词**: 大语言模型、化学反应预测、AI辅助合成、专家系统、分子发现
...
## 摘要（中文）
科学文献的指数增长提出了跨学科日益严峻的挑战。每年有成千上万的新化学反应被报道，但将它们转化为可行的实验却成为一个障碍。大型语言模型 (llm) 的最新应用已显示出希望，但可靠地用于从头化合物的各种转换的系统仍然难以捉摸。在这里，我们介绍了MOSAIC (人工智能辅助化学预测的多个优化专家)，这是一个计算框架，使化学家能够利用数百万反应协议的集体知识。MOSAIC建立在Llama-3.1-8B-Instruct建筑上，在Voronoi集群空间中培训了2,498名专业化学专家。这种方法提供了可重复和可执行的实验协议，具有复杂合成的置信度指标。总体成功率71%，实验验证证明了超过35种新化合物的实现，涵盖药品，材料，农用化学品和化妆品。值得注意的是，MOSAIC还能够发现专家培训中缺少的新反应方法，这是推进化学合成的基石。这种将大量领域划分为可搜索的专家区域的可扩展模型为AI辅助发现提供了可推广的策略，无论加速信息增长的速度超过了高效的知识访问和应用。

## 笔记
<!-- 在此处添加阅读笔记 -->

## Links
- [Full Article](https://links.springernature.com/f/a/pqVqR_7gGOjlfhCiCiz-fw~~/AABE5hA~/R87QaY9F431Ygm11sUAZF-L7hFqkHx3x4ewZ2eVCtA_p1VGTrf_oXZn0fViP0jcfclf7-igc_rPn7zZoAMAtUUMPc9priDNSKkHdmE0hKjbStMmGIHUopXQ311s0KU5PYCGoQnTZgPTILblzrAwbgVtlW4f_dvwL4m1nWSUcyXMGJLavMGOFsRs7C3uuyxeuDBzcMNj6K5ZmSv8MqNsYjBmrNP4cthJqjV1E3lN3ub08De63wTYgU_QyZReHR1Gzc-ydnXe-50wbviQ8Tlk7ppfSSNTVlyqJhSczxT2iwTA~)
