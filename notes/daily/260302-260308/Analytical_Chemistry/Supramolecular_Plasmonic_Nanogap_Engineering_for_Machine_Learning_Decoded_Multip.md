---
title: "Supramolecular Plasmonic Nanogap Engineering for Machine Learning Decoded Multiplex Chiral Amino Acid SERS Analysis"
title_zh: "用于机器学习的超分子等离子体纳米间隙工程解码多重手性氨基酸SERS分析"
...
## 摘要（中文）
手性识别传感在药物合成和生物医学应用中至关重要，但仍存在三个关键挑战: 无法同时实现对映异构体的高分辨率鉴定和表征，对控制手性识别的分子机制的理解不足以及分析复杂的手性化合物混合物的功效有限。在这里，我们提出了一种用于表面增强拉曼散射 (SERS) 手性传感的超分子等离子体纳米粒子镜 (NPoM) 平台。通过使用巯基官能化的 β-环糊精 (β-cd) 作为超分子核心进行选择性手性氨基酸捕获，该平台有助于在金纳米颗粒 (aunp) 和金薄膜 (AuF) 之间精确形成〜1.2 nm的等离子体纳米间隙热点。这种构型显著增强了对映异构体特异性拉曼信号，从而能够实现芳香族氨基酸对映异构体的高分辨率鉴定和对映选择性区分。密度泛函理论 (DFT) 计算揭示了手性识别机制: β-cd通过不同的空间构型和不同的结合亲和力与d-和l-对映异构体形成非对映异构体复合物，从而产生特征光谱差异，从而实现精确的对映选择性鉴定。此外，与机器学习 (ML) 算法的集成有助于快速，高度准确的对映体分类和未知样品的鲁棒盲预测。值得注意的是，所提出的平台在同时区分包含多种手性芳族氨基酸的复杂对映体混合物方面表现出卓越的性能，为高级手性分析提供了强大的策略。

## 笔记
<!-- 在此处添加阅读笔记 -->

## Links
- [Full Article](http://url5675.acs.org/ls/click?upn=u001.GXhmshJPA1t8vlxMR-2FToII2roP7p3-2BAW2NtcJEvBqZ6m9dwOKKpz9-2BWBhH0scpkFzpwMn7Zd3ry8TcKGKRyNoKdLaXPlxJ2fC-2FFxc04eZFzG6-2FDH1cpNWW2s1PAB-2BeXq5JqmQYpmdCOVT-2Fl6OpoMq6NdeJJ5bN-2FlocFL7bcDZVHiUFko3ef2768lIedoCp-2FaWwxE_lCfgyiCVNF2aFl1C5Hre7Otyl3MOx4XtLxhxzfQ-2BJEA4TixnLSSnHKtti6TVNqJjICV4qvQArAsWThJep5QI9va7wIKdZVjaEZp8TavinUXOLbC9Lqc0Z02fYqJlXn8U3cjG7grYeg8tXsDsMs9tgL82sOM8Fo91YpgtDR-2BBCFGVAhsmXZ88jx-2B3r7E7aiUTXc2vpBINAS5IiR9ZJhocNVJsAaLPN8MHtIDesjaeglXvMRPw8fFYzgOUqclVa5-2BkQvS3268pWuAmPkTJKx6NGESzGDdKGeZGnCQYSL3v9e8-3D)
