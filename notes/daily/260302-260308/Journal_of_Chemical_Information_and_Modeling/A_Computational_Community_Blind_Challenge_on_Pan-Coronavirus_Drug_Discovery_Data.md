...
url: "http://url5675.acs.org/ls/click?upn=u001.GXhmshJPA1t8vlxMR-2FToII2roP7p3-2BAW2NtcJEvBqZ6qwd-2BbfgJamG4wIcrwJFnPD-2BGE9T-2FlmbvVc-2BeL5ttKw084xAkw-2Fw-2BOtrd22kjfjlgczZ67NZ6fyHAr8V7yFzbDbizjLv-2Fv75QKJMo8LlfTDvdw5-2ByaTEu-2F3jXjFodAV53yI4nkvhxOyaRh9DPPGbSPsWlc_lCfgyiCVNF2aFl1C5Hre7Otyl3MOx4XtLxhxzfQ-2BJEA4TixnLSSnHKtti6TVNqJjhXgm129QW7OjPkMVv5vigIMEuG-2FfF497eI2FviJGe-2FAJacH0axbtsqD7QuhRJvVDmc8e56BHfKWbwYRHKQZh6MvIgn4FRYc62r3QVJGednfS9gV3Y2bnPveDsKWNlzYF-2FrTIPecDv4znnJ7-2FADXr-2BuBzFLpSN1Z7UgK2o9tqBQ59hktPzrlpbQkDqMMrpSBVO7QihEm-2B05nUGEWz4BkmhuIQxopxub-2BSYdIyBk0AEI0-3D"
pub_date: ""
tags: ["drug-discovery", "machine-learning", "benchmark-challenge", "coronavirus", "computational-methods"]
ai_relevance: 5
relevance: null
innovation: null
methods: null
...
## 精华总结
本文报告了一项开放科学社区盲测挑战的结果和关键见解，该挑战专注于药物发现中的计算方法，使用AI驱动的结构赋能抗病毒平台发现联盟的泛冠状病毒抗病毒发现计划的先导优化数据。通过多任务和多化合物的评估，建立了性能排行榜并进行了元分析，为实际机器学习评估的最佳实践奠定了基础。

**关键词**: 药物发现、盲测挑战、机器学习、冠状病毒、ADMET预测
...
## 摘要（中文）
计算盲测挑战提供了关键且无偏见的机会，用于评估和加速科学进步，过去十年中的一系列突破性成果对此作出了充分证明。我们报告了一项开放科学社区盲测挑战的结果和关键见解，该挑战聚焦于药物发现中的计算方法，并使用由人工智能驱动的结构赋能抗病毒平台发现联盟的泛冠状病毒抗病毒发现项目提供的先导化合物优化数据，该项目与Polaris公司和OpenADMET项目合作开展。这项合作倡议邀请了来自学术界和产业界的全球参与者，利用此前未公开的综合性实验药物发现数据集作为基准，开发并应用计算方法，以预测针对关键冠状病毒靶点——新型冠状病毒（SARS-CoV-2）和中东呼吸综合征冠状病毒（MERS-CoV）主蛋白酶（Mpro）——的小分子的生化效力和晶体学配体构象，以及多个ADMET检测终点。通过在多项任务和化合物上评估提交结果，我们建立了性能排行榜，并开展了元分析，以评估方法学的优势、常见陷阱以及有待改进的领域。本分析为现实场景中机器学习模型的评估最佳实践奠定了基础，其依据是社区驱动的基准测试。我们还强调，像Polaris这样的下一代平台能够支持严谨的挑战设计、内置的评估框架以及广泛的社区参与。本文报告了该挑战的集体研究成果，对数据集、评估基础设施以及表现最佳的算法策略进行了高层次的概述。此外，我们为本专题中由挑战赛参与者撰写的配套论文提供了背景介绍和支持，这些论文更深入地探讨了各自的解决方案。综上所述，这些贡献旨在推动药物发现领域中可复现、可信且具有重大影响力的计算方法的发展，并探索未来盲测挑战设计与实施中的最佳实践与常见陷阱，其中包括针对OpenADMET项目的既定计划。

## 笔记
<!-- 在此处添加阅读笔记 -->

## Links
- [Full Article](http://url5675.acs.org/ls/click?upn=u001.GXhmshJPA1t8vlxMR-2FToII2roP7p3-2BAW2NtcJEvBqZ6qwd-2BbfgJamG4wIcrwJFnPD-2BGE9T-2FlmbvVc-2BeL5ttKw084xAkw-2Fw-2BOtrd22kjfjlgczZ67NZ6fyHAr8V7yFzbDbizjLv-2Fv75QKJMo8LlfTDvdw5-2ByaTEu-2F3jXjFodAV53yI4nkvhxOyaRh9DPPGbSPsWlc_lCfgyiCVNF2aFl1C5Hre7Otyl3MOx4XtLxhxzfQ-2BJEA4TixnLSSnHKtti6TVNqJjhXgm129QW7OjPkMVv5vigIMEuG-2FfF497eI2FviJGe-2FAJacH0axbtsqD7QuhRJvVDmc8e56BHfKWbwYRHKQZh6MvIgn4FRYc62r3QVJGednfS9gV3Y2bnPveDsKWNlzYF-2FrTIPecDv4znnJ7-2FADXr-2BuBzFLpSN1Z7UgK2o9tqBQ59hktPzrlpbQkDqMMrpSBVO7QihEm-2B05nUGEWz4BkmhuIQxopxub-2BSYdIyBk0AEI0-3D)
