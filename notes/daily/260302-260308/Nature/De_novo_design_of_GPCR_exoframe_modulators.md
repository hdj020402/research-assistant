...
pub_date: ""
tags: ["protein-design", "deep-learning", "gpcr-modulation", "drug-discovery", "ai-protein-engineering"]
ai_relevance: 5
relevance: null
innovation: null
methods: null
...
## 精华总结
介绍了靶向G蛋白偶联受体跨膜域的GEMs作为变构调节的有效试剂,突出了深度学习方法在设计功能导向性膜蛋白中的潜力。

**关键词**: G蛋白偶联受体、深度学习、蛋白质设计、变构调节、膜蛋白
...
## 摘要（中文）
G蛋白偶联受体(GPCRs)是重要的治疗靶点,主要通过其内源性激动剂结合的正交位点进行靶向。然而,变构调节已成为GPCR药物发现领域中一种有前景且创新的策略。在受膜蛋白天然调节GPCRs的启发下,我们开发了GPCR外框调节器(GEMs),这是一类从头设计的蛋白质,特异性靶向GPCRs的跨膜域。利用一种类似幻觉的设计方法,我们通过三个战略性结构提示来设计GEMs,以实现所需的结合模式。我们选择多巴胺D1受体作为原型模型,并系统地研究了四种GEMs。结构研究和功能分析表明,这些GEMs与跨膜域结合,并作为多种变构调节剂发挥作用,包括激动剂-正变构调节剂、负变构调节剂和偏向性变构调节剂。ago-PAM GEM恢复了各种D1受体功能丧失突变体的活性,为GPCR相关疾病提示了有前景的治疗靶点。我们的工作引入了靶向跨膜域的GEMs作为变构GPCR调节的有效试剂,并强调了深度学习方法在设计功能导向性膜蛋白中的潜力。

## 笔记
<!-- 在此处添加阅读笔记 -->

## Links
- [Full Article](https://links.springernature.com/f/a/kUrfhAlczLLzcyobQfzCnA~~/AABE5hA~/R87QaY9F431Ygm11sUAZF-L7hFqkHx3x4ewZ2eVCtA-ew3iRMDnoGQElVb-LjYJl453kkEqh4lGk-Shazv5STPr4zNa354AQmvgZGreKqOUiA31KVNUkC9PxdVYJCwaKsr9S72ZXYEeNpPGdBhu66xwBzursdw5UD2jqEuhvlkEirbURn6Hsdc5MOA0s-ku1Xelpgh2VgHo0DGPefKMMLqXUUl8QhJBJxXg-4uIV_GzWLO2Hr1PpBniVujzZhI-tzDon8rhrKMWi3MzHFWTcQS6zjrpEnPDk67Nwok0ba4I~)
