...
title_zh: "UniDock-Pro：一个统一的GPU加速平台，用于高通量基于结构、基于配体以及协同混合虚拟筛选"
...
pub_date: ""
tags: ["virtual-screening", "gpu-acceleration", "drug-discovery", "molecular-docking", "high-throughput-computing"]
ai_relevance: 3
relevance: null
innovation: null
methods: null
...
**UniDock-Pro：一个统一的GPU加速平台，用于高通量基于结构、基于配体以及协同混合虚拟筛选**

## 精华总结
UniDock-Pro是一个统一的GPU加速平台，集成了基于结构的虚拟筛选、基于配体的虚拟筛选和新型混合虚拟筛选模式，能够在单个GPU上每天处理数百万化合物。

**关键词**: 虚拟筛选、GPU加速、药物发现、混合方法、高通量计算
