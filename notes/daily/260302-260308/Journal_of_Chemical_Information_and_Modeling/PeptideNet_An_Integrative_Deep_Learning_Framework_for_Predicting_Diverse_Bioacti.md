...
pub_date: ""
tags: ["deep-learning", "protein-language-models", "peptide-prediction", "bioactivity-prediction", "sequence-analysis"]
ai_relevance: 5
relevance: null
innovation: null
methods: null
...
## 精华总结
大型蛋白质语言模型嵌入与PeptideNet架构的集成使模型能够捕获全局上下文信息和残基级特征，为多肽生物活性预测建立了一个广泛适用和可解释的框架。

**关键词**: 深度学习、蛋白质语言模型、生物活性肽、特征提取、序列预测
