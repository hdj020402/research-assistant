...
pub_date: ""
tags: ["protein-ligand-docking", "generative-models", "deep-learning", "kinase-inhibitors", "drug-discovery"]
ai_relevance: 5
relevance: null
innovation: null
methods: null
...
**微调diffdock-l用于变构激酶对接**

## 精华总结
通过对DiffDock-L模型进行特定的微调策略，显著改善了变异激酶的结合位点预测，并通过与AlphaFold3和Boltz-2等共折叠模型的比较，为适应激酶结构基础药物设计中的低数据结合模式提供了实践指导。

**关键词**: 扩散模型、分子对接、变异激酶抑制剂、深度学习、药物设计
