...
pub_date: ""
tags: ["graph-neural-networks", "machine-learning", "nonadiabatic-dynamics", "hot-carrier-relaxation", "materials-simulation"]
ai_relevance: 5
relevance: null
innovation: null
methods: null
...
## 精华总结
开发了一个通用图神经网络AI2NAMD，建立从哈密顿量到热载流子弛豫动力学的端到端映射，通过机器学习将NAMD模拟加速超过百万倍。

**关键词**: 图神经网络、非绝热分子动力学、热载流子弛豫、哈密顿量预测、材料模拟
