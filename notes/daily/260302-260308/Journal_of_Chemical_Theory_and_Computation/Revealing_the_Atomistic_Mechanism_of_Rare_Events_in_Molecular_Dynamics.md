...
pub_date: ""
tags: ["deep-learning", "molecular-dynamics", "reaction-coordinates", "interpretability"]
ai_relevance: 5
relevance: null
innovation: null
methods: null
...
## 精华总结
AMORE-MD框架利用ISOKANN算法学习神经隶属函数来表示主要慢过程，通过梯度对齐重构转移路径，并通过梯度敏感性分析量化原子贡献，实现对分子动力学稀有事件的可解释性分析。

**关键词**: 深度学习、反应坐标、分子动力学、稀有事件、神经网络
