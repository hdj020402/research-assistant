...
title_zh: "用于吸附去除刚果红的高效锌基金属有机框架: 实验研究和AI驱动的验证"
journal: "Journal of Chemical Information and Modeling"
doi: "10.1021/acs.jcim.5c02371"
url: "http://url5675.acs.org/ls/click?upn=u001.GXhmshJPA1t8vlxMR-2FToII2roP7p3-2BAW2NtcJEvBqZ6qwd-2BbfgJamG4wIcrwJFnPu904Mhslr-2B-2BNCU1S7-2F3DkjGHGhiFwTSbixFsACvd7td9HnzdkvqumKoslZK2huMzweQv1o3fRQKtv8AlyccYlr9egH-2BZ9FoAUJZATxP89P4sBjGDbb-2BlxPtG-2FVfx5GQh-1Ab_lCfgyiCVNF2aFl1C5Hre7Otyl3MOx4XtLxhxzfQ-2BJEA4TixnLSSnHKtti6TVNqJjMiGhqYuNZSeljVi5kw6RDOwb5HTN1959abUlgudU81s2Gt60ueudsBUDF07PnskUrKDrglAaIRfI05JXR-2F8Dh8ch-2F55uqkTQ-2B-2BuZCYaKBzNWTXPurHDhWrs6J5K3NinFTLZ09q9DPcRwa-2BL5OgbEslx6-2BMZBILHmKqJrAgg-2BiTGsBbJsmmjyfl1QPw-2FjDFRTvV64GtXj5HUr0x86PJJsF1TPohBBisJsoiGOg8rCtng-3D"
pub_date: ""
tags: ["metal-organic-frameworks", "machine-learning", "adsorption", "wastewater-treatment", "xgboost"]
ai_relevance: 4
relevance: null
innovation: null
methods: null
...
**用于吸附去除刚果红的高效锌基金属有机框架: 实验研究和AI驱动的验证**

## 精华总结
本研究成功合成了高效锌基金属有机框架(ZnBTC MOF)用于刚果红吸附去除,实现了94%以上的去除效率。通过机器学习(XGBoost、随机森林、ANN等)对实验数据进行建模和验证,建立了可靠的吸附性能预测模型,R²值达0.968,证实了树基集成算法在小型结构化数据集中的优越性。

**关键词**: 金属有机框架、机器学习、吸附、刚果红、XGBoost、废水处理
...
## 摘要（中文）
缓解有害环境危害，例如水体中的有机染料，仍是一项紧迫的挑战。本研究成功地利用一种高效的锌基金属有机框架材料（MOF），实现了从水溶液中吸附去除刚果红（CR）。实验设计通过机器学习（ML）进行了验证，并对关键参数进行了优化，以建立吸附性能的模型并进行预测。在常温常压条件下，采用一种简便的合成方法，通过羟基双盐（HDS）中间体合成了苯三羧酸锌金属有机框架材料（ZnBTC）。所得的ZnBTC MOF由锌节点通过羧酸酯桥联体相连，形成具有规整孔道和较高比表面积的三维多孔框架结构。该结构特征已通过扫描电子显微镜、透射电子显微镜、傅里叶变换红外光谱、X射线衍射、氮气吸附-脱附分析以及X射线光电子能谱等手段得到证实。该材料在60分钟的接触时间内，对不同浓度的CR均表现出超过94%的优异去除效率。通过开展一项详尽的研究，系统考察了染料初始浓度、温度、溶液pH值、吸附剂投加量以及共存离子等因素对ZnBTC吸附染料性能的影响，结果表明该材料作为染料吸附剂具有优异的稳定性与可靠性。为进一步阐明并预测吸附性能，研究中获得的实验数据集被整合到机器学习模型中。比较了四种基本方法，即极端梯度提升（XGBoost）、随机森林（RF）、人工神经网络（ANN）和线性回归（LR）。XGBoost模型表现最为强劲，测试R2值达到0.968，并确定催化剂用量和接触时间为控制变量。这确立了基于树的集成机器学习算法在预测MOF基吸附性能方面的优越性，进一步证实了这类方法特别适用于小型、结构化数据集。热力学、等温线及动力学分析证实，CR的吸附过程具有自发性且以化学吸附为主，同时氢键作用、传质效应以及π–π相互作用也对吸附过程起到了一定的贡献。鉴于其制备简便、生物相容性良好，且在多种运行条件下均能保持持久高效的性能，ZnBTC有望成为污水处理系统中去除CR的高效吸附剂。此外，实验与人工智能驱动相结合的方法为吸附研究提供了一种可靠的决策支持工具，这凸显了本研究在将材料科学与人工智能相融合、构建用于废水修复研究的可靠决策支持框架方面的重要意义。

## 笔记
<!-- 在此处添加阅读笔记 -->

## Links
- [Full Article](http://url5675.acs.org/ls/click?upn=u001.GXhmshJPA1t8vlxMR-2FToII2roP7p3-2BAW2NtcJEvBqZ6qwd-2BbfgJamG4wIcrwJFnPu904Mhslr-2B-2BNCU1S7-2F3DkjGHGhiFwTSbixFsACvd7td9HnzdkvqumKoslZK2huMzweQv1o3fRQKtv8AlyccYlr9egH-2BZ9FoAUJZATxP89P4sBjGDbb-2BlxPtG-2FVfx5GQh-1Ab_lCfgyiCVNF2aFl1C5Hre7Otyl3MOx4XtLxhxzfQ-2BJEA4TixnLSSnHKtti6TVNqJjMiGhqYuNZSeljVi5kw6RDOwb5HTN1959abUlgudU81s2Gt60ueudsBUDF07PnskUrKDrglAaIRfI05JXR-2F8Dh8ch-2F55uqkTQ-2B-2BuZCYaKBzNWTXPurHDhWrs6J5K3NinFTLZ09q9DPcRwa-2BL5OgbEslx6-2BMZBILHmKqJrAgg-2BiTGsBbJsmmjyfl1QPw-2FjDFRTvV64GtXj5HUr0x86PJJsF1TPohBBisJsoiGOg8rCtng-3D)
