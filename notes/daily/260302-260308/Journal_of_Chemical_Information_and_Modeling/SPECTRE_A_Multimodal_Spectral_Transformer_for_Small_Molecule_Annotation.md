...
title_zh: "SPECTRE：用于小分子标注的多模态谱变换器"
...
pub_date: ""
tags: ["transformer-architecture", "nmr-spectroscopy", "molecular-annotation", "drug-discovery", "deep-learning"]
ai_relevance: 5
relevance: null
innovation: null
methods: null
...
**SPECTRE：用于小分子标注的多模态谱变换器**

## 精华总结
SPECTRE是一个基于Transformer的最先进模型，用于小分子结构去重和注释，能够接受多种类型的NMR数据进行灵活注释，并采用新颖的熵优化分子二进制指纹增强分子候选检索的准确性。

**关键词**: Transformer模型、NMR光谱、结构注释、分子指纹、自然产物
