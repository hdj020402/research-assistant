...
pub_date: ""
tags: ["machine-learning-potentials", "electrochemistry-simulation", "li-ion-battery", "neural-network-force-fields", "molecular-dynamics"]
ai_relevance: 5
relevance: null
innovation: null
methods: null
...
## 精华总结
开发了基于消息传递的机器学习原子间势（MPNICE），能够准确描述锂离子电池电解质的电化学还原过程，特别是在处理非中心自由基等复杂体系时保持1 kcal/mol的精度。该方法通过迭代电荷平衡策略，成功解决了传统力场在键合和电子转移上的限制，为固体电解质界面形成的原子级模拟提供了新的见解。

**关键词**: 机器学习势、电化学还原、锂离子电池、固体电解质界面、电荷平衡
