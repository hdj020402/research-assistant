...
pub_date: ""
tags: ["drug-repurposing", "graph-neural-networks", "contrastive-learning", "multimodal-learning", "microbiome"]
ai_relevance: 5
relevance: null
innovation: null
methods: null
...
## 精华总结
提出了DVMMHGNN框架，一个异构图对比学习方法用于微生物信息驱动的药物再利用，通过整合结构和元路径信息，在预测药物-疾病关联方面超越了九种最先进的方法。

**关键词**: 药物再利用、异构图神经网络、对比学习、微生物组、药物-疾病关联预测
