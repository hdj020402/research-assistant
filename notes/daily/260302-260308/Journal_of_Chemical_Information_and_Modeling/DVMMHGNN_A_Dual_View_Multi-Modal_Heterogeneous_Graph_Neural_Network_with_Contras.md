...
title_zh: "DVMMHGNN: 具有对比学习的双视图多模式异构图神经网络，用于了解微生物的药物再利用"
...
pub_date: ""
tags: ["graph-neural-networks", "drug-repurposing", "contrastive-learning", "multimodal-learning", "computational-drug-discovery"]
ai_relevance: 5
relevance: null
innovation: null
methods: null
...
**DVMMHGNN: 具有对比学习的双视图多模式异构图神经网络，用于了解微生物的药物再利用**

## 精华总结
提出了DVMMHGNN框架，一个异构图对比学习方法，用于微生物信息驱动的药物重定位，通过整合结构和元路径信息，在药物-疾病关联预测中持续优于九种最先进的方法。

**关键词**: 药物重定位、异构图神经网络、对比学习、微生物组、药物-疾病关联预测
