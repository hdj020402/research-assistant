...
pub_date: ""
tags: ["generative-models", "polymer-science", "variational-autoencoder", "molecular-dynamics", "deep-learning"]
ai_relevance: 4
relevance: null
innovation: null
methods: null
...
## 精华总结
有趣的是，从解码器输出开始生成标准结构所需的分子动力学弛豫时间比纯MD方法采样结构所需的弛豫时间小一个数量级，表明该方法在采样不相关结构方面具有计算优势。

**关键词**: 变分自编码器、聚合物结构生成、分子动力学、深度学习、距离矩阵
