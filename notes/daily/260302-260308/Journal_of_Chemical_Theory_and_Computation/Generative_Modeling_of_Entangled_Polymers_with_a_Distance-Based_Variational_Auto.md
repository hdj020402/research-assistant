...
pub_date: ""
tags: ["generative-models", "variational-autoencoder", "polymer-simulation", "deep-learning", "molecular-dynamics"]
ai_relevance: 4
relevance: null
innovation: null
methods: null
...
## 精华总结
该研究提出了一种基于距离矩阵的变分自编码器框架，用于学习和生成缠结聚合物的构型，其分子动力学松弛时间比纯MD方法小一个数量级，提供了显著的计算优势。

**关键词**: 变分自编码器、聚合物构型、距离矩阵、生成建模、分子动力学
