...
pub_date: ""
tags: ["deep-learning", "transformer-models", "nmr-spectroscopy", "molecular-annotation", "drug-discovery"]
ai_relevance: 4
relevance: null
innovation: null
methods: null
...
## 精华总结
SPECTRE是一个基于Transformer的最先进模型，用于结构解重和注释，能够接受多种NMR数据进行灵活注释，并采用新颖的熵优化分子二进制指纹增强候选分子检索的准确性。

**关键词**: Transformer模型、NMR谱解析、分子结构注释、分子指纹、深度学习
