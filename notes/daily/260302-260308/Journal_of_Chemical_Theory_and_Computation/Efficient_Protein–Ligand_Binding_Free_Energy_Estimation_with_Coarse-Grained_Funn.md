...
pub_date: ""
tags: ["free-energy-calculation", "molecular-dynamics", "protein-ligand-binding", "coarse-graining", "enhanced-sampling"]
ai_relevance: 2
relevance: null
innovation: null
methods: null
...
## 精华总结
本研究提出了粗粒化漏斗元动力学(CG-FMD)方法,结合Martini 3力场实现了高效准确的蛋白-配体结合自由能预测,在保持物理基础的同时大幅降低计算成本。通过累积超过7毫秒的模拟数据,该方法在多种配体和靶点上验证了其鲁棒性,为连接全原子分子动力学精度与高通量对接能力的问题提供了新的解决方案。

**关键词**: 蛋白-配体结合、自由能计算、粗粒化分子动力学、元动力学、计算化学
