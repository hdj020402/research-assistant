...
pub_date: ""
tags: ["deep-learning", "molecular-dynamics", "free-energy-calculation", "surrogate-modeling", "rare-event-sampling"]
ai_relevance: 5
relevance: null
innovation: null
methods: null
...
## 精华总结
介绍了BiLSTMK-MD方法，一种神经时间序列学习方法，通过构建因果关系保留的分子动力学和自由能扰动轨迹代理模型，显著降低采样需求，为自由能估计和稀有事件特征化提供了新途径。

**关键词**: 神经网络、分子动力学模拟、自由能扰动、时间序列学习、LSTM
