...
pub_date: ""
tags: ["molecular-dynamics", "coarse-graining", "force-field-development", "computational-biochemistry", "polysaccharide-modeling"]
ai_relevance: 2
relevance: null
innovation: null
methods: null
...
## 精华总结
本研究基于Martini 3力场开发了硫酸软骨素A (CSA)的粗粒度分子动力学模拟模型，该模型能够准确再现CSA的原子性质和聚合物结构特性，同时显著降低计算成本。研究探索了静电相互作用对CSA聚集的影响，并提出了三种策略来解决默认Martini 3参数导致的过度聚集问题，为高度带电生物大分子的粗粒度建模提供了重要指导。

**关键词**: 粗粒度分子动力学、Martini力场、硫酸软骨素A、静电相互作用、分子模型
