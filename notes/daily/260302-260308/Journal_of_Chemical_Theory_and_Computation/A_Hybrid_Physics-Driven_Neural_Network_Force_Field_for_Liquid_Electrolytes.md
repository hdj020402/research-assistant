...
pub_date: ""
tags: ["machine-learning-potential", "force-field-development", "battery-electrolytes", "physics-informed-learning", "molecular-simulation"]
ai_relevance: 4
relevance: null
innovation: null
methods: null
...
## 精华总结
本工作提出了PhyNEO-Electrolyte混合物理驱动-数据驱动方法，通过单体和二聚体能量分解分析数据构建力场，在改进机器学习原子间势的可转移性和稳定性的同时显著降低了训练数据需求。该方法能够准确描述电解质系统中的长程渐近行为，为电池电解质设计空间的探索提供了高效鲁棒的计算工具。

**关键词**: 混合物理驱动力场、机器学习势、电解质设计、能量分解分析、锂离子电池
