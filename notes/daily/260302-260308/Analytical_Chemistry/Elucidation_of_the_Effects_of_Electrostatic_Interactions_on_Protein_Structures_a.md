---
title: "Elucidation of the Effects of Electrostatic Interactions on Protein Structures at Buried Solid/Liquid Interfaces: A Combined Study with Experiment, Simulation, Isotope Labeling, and Spectra Calculation"
title_zh: "阐明静电相互作用对埋藏的固/液界面蛋白质结构的影响: 与实验，模拟，同位素标记和光谱计算的结合研究"
...
# Elucidation of the Effects of Electrostatic Interactions on Protein Structures at Buried Solid/Liquid Interfaces: A Combined Study with Experiment, Simulation, Isotope Labeling, and Spectra Calculation
...
## 摘要（中文）
埋藏的固/液界面处的蛋白质结构和相互作用对于生物传感器，生物医学设备和防污涂层中的应用至关重要。在这里，我们研究了吸附在 (3-氨基丙基) 三乙氧基硅烷 (APTES) 自组装单层 (SAM) 表面上的野生型 (WT) 和突变 (MT) 蛋白GB1s的构象和取向。频率生成 (SFG) 振动光谱，同位素标记，原子分子动力学 (MD) 模拟和哈密顿光谱计算。我们的结果表明，WT GB1和MT GB1在APTES表面上采用相似的结构，由于占主导地位的静电相互作用，与它们在 π-π 相互作用显著的石墨烯和聚苯乙烯界面上的不同结构相反。在这里，蛋白GB1的C-末端 β-折叠主要与带正电荷的APTES表面相互作用，正如MD模拟和SFG光谱匹配所证明的那样。同位素标记通过提供额外的独立测量参数而不改变蛋白质构象来增强结构解析。该研究证明了这种综合方法在原位解析界面蛋白质结构的能力，有助于我们理解界面蛋白质的行为和功能。

## 笔记
<!-- 在此处添加阅读笔记 -->

## Links
- [Full Article](http://url5675.acs.org/ls/click?upn=u001.GXhmshJPA1t8vlxMR-2FToII2roP7p3-2BAW2NtcJEvBqZ6m9dwOKKpz9-2BWBhH0scpkFVwVDr5pL92q4nRGGa4xOkjfD-2FeJcXy4dwYFFCSgSOYL07sIY-2B1ssY-2B3rIfYiLXVXOwHuHjiwG6AHJCfhQ8WSp3oeqrKDCF-2BaCLColYR3FNuiD26s728XrienMY1UtVIog7gX_lCfgyiCVNF2aFl1C5Hre7Otyl3MOx4XtLxhxzfQ-2BJEA4TixnLSSnHKtti6TVNqJjICV4qvQArAsWThJep5QI9va7wIKdZVjaEZp8TavinUW1RIJltQawh-2Bfvvsd-2F8JuJDEbLMaGXwsvgz22gxhU39UTzU3Wj-2FrPa2aujgj0eMWe-2B-2FUeV55aktvNKpe-2F2SQgckN4gVq6lRbvetahpm0Nuzs5CYSXpX2m4GJSMWYR3yKUMyxc6kWpiM8SA4ENVDx5V4P20FsgSgvRbOdc8PBZ96sYcLGZTynYEfWTgoHw47tc-3D)
